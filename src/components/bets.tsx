...
export default function Bet({ betAmount, handleChangeBet }: BetProps){
    ...
    return (
        ...
        <h1 className="text-white text-xl font-mono p-3 rounded-xl underline">Bet: {betAmount}</h1>
        <h1 className="text-white text-xl font-mono p-3 rounded-xl underline">On the table: {}</h1>
        <h1 className="text-white text-xl font-mono p-3 rounded-xl underline">Balance: {}</h1>
